...
They are made by hand from real footage and are **not** regenerated by
`manualshots.py`, so a rebuild leaves them alone and they have to be carried
across by hand if `docs/images/` is ever rebuilt from scratch.
